...
OBS_FILE = 'mock_population_weights.h5'
COMPAS_H5 = "/fred/oz101/avajpeyi/COMPAS_DATA/h5out_32M.h5"
OUTDIR = "outdir"
MODEL_CACHE = "/fred/oz101/avajpeyi/code/jeff_ci/docs/studies/generate_data/out_32M.csv"

# check all files exist
if not os.path.exists(COMPAS_H5):
    raise FileNotFoundError(f"COMPAS h5 file {COMPAS_H5} does not exist.")
if not os.path.exists(OBS_FILE):
    raise FileNotFoundError(f"Observation file {OBS_FILE} does not exist.")
...
observation = Observation.from_ilya(OBS_FILE)
